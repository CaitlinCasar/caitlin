...
3. <p>Now, you’ll need to set your credentials in Git. Open up your Mac terminal or [gitbash](https://www.atlassian.com/git/tutorials/git-bash) on PC, then use the git config commands to configure your username and email. This will ensure that you have the ability to modify repositories on Github.</p>
...
2. <p>Install the blogdown package. You can do this in RStudio by entering the following in the console window in the bottom panel:</p>
...
<p>Open up the markdown file you just created. You should see something like this:</p>
```{r, eval=F}
---
...
categories: [] #add categories for your post inside the brackets
tags: [] #add tags inside the brackets
subtitle: ''
summary: ''
authors: [] #add your name inside these brackets to indicate who authored the post
...
<p>Here's an exaple of how to modify this header:</p>
```{r, eval=F}
---
title: my blog post title
author: ~
